      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form action="{{ route('admin.pages.store') }}" method="POST" name="create_page" id="create_page">
                @csrf
                    <div class="box-body">
                     ...
                     Page Type <font color="red">*</font>
                        ...
                        <select name="page_type" class="form-control" onchange="enablepageoptions(this.value)" >
                         ...
                         <option value="home">Home Page Content</option>
                         <option value="innerpage">Inner Contnet</option>
                        </select>
                       </div>
                      ...
                      English Title <font color="red">*</font>
                        ...
                        <input type="text" placeholder="English Title" name="title_english" class="form-control" id="title_english"  value="" >
                        </div>
                      ...
                      <div class="form-group">
                       ...
                       Marathi Title <font color="red">*</font>
                          ...
                          <input type="text" placeholder="Marathi Title" name="title_marathi" class="form-control" id="title_marathi"   value="" >
                        </div>
                      ...
                      Url Title <font color="red">*</font>
                        ...
                        <input type="text" placeholder="Url Title" name="url_word" class="form-control" id="url_word"   value="" >
                            </div>
                      ...
                      <textarea type="text" placeholder="Page Description (English)" id="desc_english" name="desc_english" class="form-control ckeditor"  ></textarea>
                       </div>
                      ...
                      <textarea type="text" placeholder="Page Description (Marathi)" id="desc_marathi" name="desc_marathi"  class="form-control ckeditor" 
                      ></textarea>
                       </div>
