          ...
          <div class="box box-primary">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body table-responsive">
                    ...
                    <tr>
                        <td>{{ ++$i }}</td>
                        <td>{{ $page->title_english }}</td>
                        <td>{{ $page->title_marathi }}</td>
                        <td>
                          <a class="btn btn-warning" href="#">{{ $page->status }}</a>   
                        </td>
                        <td>
                            <form action="{{ route('admin.pages.destroy',$page->pageid) }}" method="GET">
               
                                <a class="btn btn-info" href="{{ route('admin.pages.show',$page->pageid) }}">Details</a>
                
                                <a class="btn btn-primary" href="{{ route('admin.pages.edit',$page->pageid) }}">Edit</a>
